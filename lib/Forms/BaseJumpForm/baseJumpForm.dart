...
import 'package:riser/Forms/BaseJumpForm/BaseJumpWidgets/baseJumpInfoWidgets.dart';
import 'package:riser/SwitchWidgets/BaseJumpSwitch/baseJumpSwitch.dart';

import '../../main.dart';

class BaseJumpForm extends StatefulWidget {
  @override
  _BaseJumpFormState createState() => _BaseJumpFormState();
}

class _BaseJumpFormState extends State<BaseJumpForm> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Row(
            children: <Widget>[
              Expanded(child: BaseJumpGearSwitch()),
            ],
          )
        ],
      ),

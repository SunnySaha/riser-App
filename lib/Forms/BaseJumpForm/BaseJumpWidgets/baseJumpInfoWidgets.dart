...
class BaseJumpInfoWidgets extends StatefulWidget {
  @override
  _BaseJumpInfoWidgetsState createState() => _BaseJumpInfoWidgetsState();
}

class _BaseJumpInfoWidgetsState extends State<BaseJumpInfoWidgets> {

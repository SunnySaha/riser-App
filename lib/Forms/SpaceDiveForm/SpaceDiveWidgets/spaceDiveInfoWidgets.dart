...
class SpaceDiveInfoWidgets extends StatefulWidget {
  @override
  _SpaceDiveInfoWidgetsState createState() => _SpaceDiveInfoWidgetsState();
}

class _SpaceDiveInfoWidgetsState extends State<SpaceDiveInfoWidgets> {
...
//         //       fontWeight: FontWeight.bold),
//         // ),
//         // infoContainer("DZ", "Skydive Mossel Bay"),
//         Expanded(
//           child: Container(
...
//                 contentPadding:
//                     EdgeInsets.only(left: 5, bottom: 4, top: 2, right: 1),
...
//           ),
//           // Text(
//           //   details, //"Skydive Mossel Bay", // widget.index.id == null ? "" : '${widget.index.id}',
//           //   maxLines: 4,
//           //   overflow: TextOverflow.ellipsis,
//           //   style: TextStyle(
//           //       fontSize: 15,
...
//                               fontWeight: FontWeight.w400)),
//                   items:
//                       _jumpType.map<DropdownMenuItem<String>>((String value) {
//                     return DropdownMenuItem<String>(
//                       value: value,
//                       child: Text(value,
//                           style: TextStyle(
...
//           //       Text('  '),
//           //       Text(
//           //         details2, //"Skydive Mossel Bay", // widget.index.id == null ? "" : '${widget.index.id}',
//           //         maxLines: 4,
//           //         overflow: TextOverflow.ellipsis,
//           //         style: TextStyle(
//           //             fontSize: 15,
...
//     );
//   }
//     void _onDropdownSelectedJumpType(String newValue) {
//     setState(() {
//       this._currentJumpSelected = newValue;
//       if (newValue == 'Coaching Jump')  {
//         print('Coaching Jump');
//         _coachingDropdown();
//       }
//       // else if (newValue == 'Specialized Camera')  { 
//       //   print('Specialized Camera');
//       //   _specializedCameraDropdown();
//       // }
//       // else if (newValue == 'Tandem')  { 
//       //   print('Tandem');
//       //   _tandemDropdown();
//       // }
//       // else if (newValue == 'AFF')  { 
//       //   print('AFF');
//       //   _aFFDropdown();
//       // }
...
//    }
//   //  void _specializedCameraDropdown() {}
//   //  void _tandemDropdown() {}
//   //  void _aFFDropdown() {}
// /////////////////////////      Info Container End    ////////////////////////////////
// }

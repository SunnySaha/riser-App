...
import 'package:riser/Forms/TunnelForm/TunnelWidgets/tunnelInfoWidgets.dart';
import 'package:riser/SwitchWidgets/TunnelGearSwitch/tunnelGearSwitch.dart';

import '../../main.dart';

class TunnelForm extends StatefulWidget {
  @override
  _TunnelFormState createState() => _TunnelFormState();
}
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Row(
            children: <Widget>[
              Expanded(child: TunnelGearSwitch()),
            ],
          )
        ],
      ),

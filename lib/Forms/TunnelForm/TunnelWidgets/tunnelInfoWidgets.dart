...
class TunnelInfoWidgets extends StatefulWidget {
  @override
  _TunnelInfoWidgetsState createState() => _TunnelInfoWidgetsState();
}

class _TunnelInfoWidgetsState extends State<TunnelInfoWidgets> {

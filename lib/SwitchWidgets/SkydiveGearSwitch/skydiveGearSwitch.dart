...
import 'package:riser/SwitchWidgets/SkydiveGearSwitch/CameraClick/cameraClick.dart';
import 'package:riser/SwitchWidgets/SkydiveGearSwitch/ParasuitClick/parasuitClick.dart';
import 'package:riser/SwitchWidgets/SkydiveGearSwitch/RigClick/rigClick.dart';
...
class SkydiveGearSwitch extends StatefulWidget {
  @override
  _SkydiveGearSwitchState createState() => _SkydiveGearSwitchState();
}

class _SkydiveGearSwitchState extends State<SkydiveGearSwitch> {
...
//////// Selected Body Method Start /////////
  ...
  Widget getRigWidget() {
    return Container(
    child: SkydiveRigClick(),
    );
  }

  Widget getParasuitWidget() {
    return Container(
      child: SkydiveParasuitClick(),
    );
  }

  Widget getCameraWidget() {
    return Container(
      child: SkydiveCameraClick(),
    );
  }

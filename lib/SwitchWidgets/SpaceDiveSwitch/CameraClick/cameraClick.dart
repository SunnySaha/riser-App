...
class SpaceDiveCameraClick extends StatefulWidget {
  @override
  _SpaceDiveCameraClickState createState() => _SpaceDiveCameraClickState();
}

class _SpaceDiveCameraClickState extends State<SpaceDiveCameraClick> {
  List len1 = [5, 5];
  List len2 = [];
  List itemsLen = [5, 5, 5];

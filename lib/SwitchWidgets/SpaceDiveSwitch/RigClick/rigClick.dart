...
class SpaceDiveRigClick extends StatefulWidget {
  @override
  _SpaceDiveRigClickState createState() => _SpaceDiveRigClickState();
}

class _SpaceDiveRigClickState extends State<SpaceDiveRigClick> {
  List len1 = [5];
  List len2 = [5];

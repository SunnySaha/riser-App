...
class BaseJumpCameraClick extends StatefulWidget {
  @override
  _BaseJumpCameraClickState createState() => _BaseJumpCameraClickState();
}

class _BaseJumpCameraClickState extends State<BaseJumpCameraClick> {
  List len1 = [5, 5];
  List len2 = [];
  List itemsLen = [5, 5, 5];

...
class BaseJumpRigClick extends StatefulWidget {
  @override
  _BaseJumpRigClickState createState() => _BaseJumpRigClickState();
}

class _BaseJumpRigClickState extends State<BaseJumpRigClick> {
  List len1 = [5];
  List len2 = [5];

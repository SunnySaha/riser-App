...
import 'package:riser/SwitchWidgets/BaseJumpSwitch/CameraClick/cameraClick.dart';
import 'package:riser/SwitchWidgets/BaseJumpSwitch/ParasuitClick/parasuitClick.dart';
import 'package:riser/SwitchWidgets/BaseJumpSwitch/RigClick/rigClick.dart';
...
class BaseJumpGearSwitch extends StatefulWidget {
  @override
  _BaseJumpGearSwitchState createState() => _BaseJumpGearSwitchState();
}

class _BaseJumpGearSwitchState extends State<BaseJumpGearSwitch> {
...
//////// Selected Body Method Start /////////
  ...
  Widget getRigWidget() {
    return Container(
    child: BaseJumpRigClick(),
    );
  }

  Widget getParasuitWidget() {
    return Container(
      child: BaseJumpParasuitClick(),
    );
  }

  Widget getCameraWidget() {
    return Container(
      child: BaseJumpCameraClick(),
    );
  }

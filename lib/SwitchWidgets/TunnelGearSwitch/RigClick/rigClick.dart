...
class TunnelRigClick extends StatefulWidget {
  @override
  _TunnelRigClickState createState() => _TunnelRigClickState();
}

class _TunnelRigClickState extends State<TunnelRigClick> {
  List len1 = [5];
  List len2 = [5];
